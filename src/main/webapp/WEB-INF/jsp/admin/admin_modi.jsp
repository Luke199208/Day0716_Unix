        ...
        <div id="main">            
            ...
            <form action="" method="post" class="main_form">
                    ...
                    <div class="input_info">
                        <input type="text" value="${admin.admin_name}" name="admin_name"/>
                    ...
                    <div class="input_info">
                        <input type="text" value="${admin.admin_telephone}" name="admin_telephone" />
                        <span class="required">*</span>
                        <div class="validate_msg_long error_msg">正确的电话号码格式：手机或固话</div>
                    </div>
                    <div class="text_info clearfix"><span>Email：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" value="${admin.admin_email}" name="admin_email"/>
                        <span class="required">*</span>
                        ...
                        <div class="input_info_scroll">
                            <ul>
                                <c:forEach items="${roleInfoList}" var="role">
                                    <li><input type="checkbox" name="${role.role_id}" value="${role.role_name}"
                                    <c:forEach items="${admin.role_infoList}" var="admin_role">
                                        <c:if test="${admin_role.role_name == role.role_name}">
                                            checked
                                        </c:if>
                                    </c:forEach>
                                    />${role.role_name}</li>
