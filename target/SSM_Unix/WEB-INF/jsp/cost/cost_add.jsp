...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form id="form" action="<c:url value="/cost/addCostT.do"/>" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="cost_type" id="monthly" onclick="feeTypeChange(1);" value="1"/>
                    <label for="monthly">包月</label>
                    <input type="radio" name="cost_type" checked="checked" id="package" onclick="feeTypeChange(2);" value="2" />
                    <label for="package">套餐</label>
                    <input type="radio" name="cost_type" id="timeBased" onclick="feeTypeChange(3);" value="3"/>
                ...
                <div class="button_info clearfix">
                    ...
                    <input type="button" value="取消" class="btn_save" onclick="location.href='<c:url value="/cost/findAll.do"/> '" />
                </div>
            </form>  
        </div>
