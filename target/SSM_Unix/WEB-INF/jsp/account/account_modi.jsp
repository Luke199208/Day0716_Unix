...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
        ...
        <div id="main">  
            ...
            <form action="<c:url value="/account/modiAcc.do"/>" method="post" class="main_form">
                    <!--必填项-->
                    ...
                    <div class="input_info">
                        <input type="text" class="width200" value="${account.telephone}"/>
                        <span class="required">*</span>
                        <div class="validate_msg_medium error_msg">正确的电话号码格式：手机或固话</div>
                    </div>
                    <div class="text_info clearfix"><span>推荐人身份证号码：</span></div>
                    <div class="input_info">
                        <input type="text" value="${reaccount.idcard_no}"/>
                    ...
                    <div class="input_info">
                        <input type="text" class="width200" value="${account.email}"/>
                        <div class="validate_msg_medium">50长度以内，合法的 Email 格式</div>
                    </div> 
                    <div class="text_info clearfix"><span>职业：</span></div>
                    <div class="input_info">
                        <select id="select">
                            <option id="gb">干部</option>
                            <option id="xs">学生</option>
                            <option id="js">技术人员</option>
                            <option id="qt">其他</option>
                        </select>                        
                    </div>
                    ...
                    <div class="input_info">
                        <input type="text" class="width350" value="${account.mailaddress}"/>
                        <div class="validate_msg_tiny">50长度以内</div>
                    </div> 
                    <div class="text_info clearfix"><span>邮编：</span></div>
                    <div class="input_info">
                        <input type="text" value="${account.zipcode}"/>
        ...
        <script type="">
            $(function () {
                var occupation = "${account.occupation}";
                if (occupation == '干部') $("#gb").attr("selected");
                if (occupation == '学生') $("#xs").attr("selected");
                if (occupation == '技术人员') $("#js").attr("selected");
                if (occupation == '其他') $("#qt").attr("selected");
            });
            $(function () {
               var gender = "${account.gender}";
                if (gender == '1') $("#male").attr("checked","checked");
                if (gender == '2') $("#female").attr("checked","checked");
            });
            $(function () {
                var flag = "${flag}";
                if (flag == "true"){
